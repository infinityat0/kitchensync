...
//import com.css.kitchensync.common.Shelf
//import com.css.kitchensync.common.ShelfStatus
...
//                    "[${order.id}] wrong temperature for the order. " +
...
//            }
//            else {
//                logger.info("[${order.id}] order discarded. name=${order.name}")
//                // cancel the driver
...
//            logger.info("[${order.id}] order expired: cancelling driver. order=${order.name}")
//            dispatcher.cancelDriverForOrder(order)
//        }
...
//            logger.ifDebug { "[${order.id}] ${order.name} currentValue=$orderValue, normalized=$normalized" }
//            OrderStatus(order.id, order.name, shelf.name, order.temp, orderValue, normalized)
//        }
...
//                        logger.info("[${order.id}] ${order.name} moved from overflow -> ${shelf.name}")
//                    }
//                }
//            }
//        }
